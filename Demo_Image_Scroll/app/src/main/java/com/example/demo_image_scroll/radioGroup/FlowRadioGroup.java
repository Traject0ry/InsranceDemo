package com.example.demo_image_scroll.radioGroup;/*
...
public class FlowRadioGroup extends LinearLayout {
    ...
    /**
     * 通过RadioButton的文字来设置选中状态
     * @param str
     * @param checked
     */
    public void setCheckedStateByText(String str,boolean checked)
    {
    ...
    public CharSequence getCheckedRadioButtonText(){
        ...
        if (checkedView != null && checkedView instanceof RadioButton) {
           return  ((RadioButton) checkedView).getText();
